...
import { ICreateCommentRequestDTO, ICreateCommentResponseDTO } from "@dto/comment/ICreateCommentDTO";
import { ICommentRepository } from "@ports/ICommentRepository";
import { IPostRepository } from "@ports/IPostRepository";
import { IUserRepository } from "@ports/IUserRepository";

export class CreateCommentUseCase implements IBaseUseCase<ICreateCommentRequestDTO, ICreateCommentResponseDTO>{
    constructor(
    ...
    async execute(input: ICreateCommentRequestDTO): Promise<ICreateCommentResponseDTO> {
        ...
        const commentInstance = new Comment(this.idGenerator.generate(),user_id, post_id)
